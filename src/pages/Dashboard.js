...
function Dashboard() {
  ...
  const getData = () => {
    ...
    axios
      .get(
        "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=false?x_cg_demo_api_key=CG-jS1XUGJp5zhY4GaqPBcYTfgA"
      )
      .then((response) => {
